  ...
  return (
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      >
        ...
        <div className="z-10 absolute top-[55%] left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] backdrop-blur-3xl rounded-full bg-[radial-gradient(circle_at_25%_90%,_rgba(30,107,75,0.15)_15%,_rgba(0,0,0,0.2)_70%,_rgba(0,0,0,0.3)_100%)]"></div>
      </motion.div>
