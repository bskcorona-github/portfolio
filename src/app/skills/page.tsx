  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "VBA", icon: DiMsqlServer, color: "#217346" },
      ],
    },
    {
      id: "databases",
      ...
      skills: [
        ...
        { name: "DBeaver", icon: FaDatabase, color: "#382923" },
        { name: "HeidiSQL", icon: FaDatabase, color: "#0066cc" },
        { name: "SQLdeveloper", icon: FaDatabase, color: "#f80000" },
        { name: "pgmodeler", icon: SiPostgresql, color: "#336791" },
      ],
    },
    {
      id: "cloud",
      ...
      skills: [
        ...
        { name: "AWS Cognito", icon: SiAmazon, color: "#ff9900" },
        { name: "CodePipeline", icon: SiAmazon, color: "#ff9900" },
        { name: "CodeCommit", icon: SiAmazon, color: "#ff9900" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "TortoiseSVN", icon: SiGit, color: "#809cc9" },
      ],
    },
    {
      id: "cicd",
    ...
    },
    {
      ...
      icon: "📊",
      skills: [
        { name: "Redmine", icon: MdWork, color: "#b32024" },
        { name: "Slack", icon: SiSlack, color: "#4a154b" },
        { name: "Notion", icon: SiNotion, color: "#000000" },
        { name: "Backlog", icon: MdWork, color: "#2f6718" },
